# 🏛️ Global Tech University | Web Portal MVP
...
Because this project utilizes a lightweight, static architecture (no backend databases or Node modules), setting it up locally is instantaneous.
...
3. **Run the application:**
   Simply double-click `index.html` to open the portal in any modern web browser. No local server installation is required.
